...
class QuickListTest {
    ...
    @Test
    void whenComparingForName() {
        User user1 = new User(1, "Alex");
        User user2 = new User(1, "Gleb");
        User user3 = new User(3, "Sergey");
        User user4 = new User(-4, "Nikita");
        User user5 = new User(4, "Dima");
        User user6 = new User(6, "Evgeniy");
        ...
        QuickList.quickSort(listUser, comparator);
        List<Integer> result = listUser.stream().map(User::getId).toList();
        assertThat(result).containsExactly(1, 4, 6, 1, -4, 3);
    }
